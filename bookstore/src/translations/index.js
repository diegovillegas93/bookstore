export default {
    ...
    navigation: {
        ...
        cart: 'Carrito',
        orders: 'Mis pedidos',
        about: 'Acerca de' // adicional
    },
    about_page:{ // me descripcion
        description:'Esta pagina es un pequeño proyecto web del curso gratuito de VUE JS + FIREBASE',
        author:'Daniel Vargas Castro',
        place:'Universidad de Guayaquil Facultad, laboratorios de Jurisprudencia',
        sponsors:'Ing. Luis Reategui'
    },
    welcome: {
